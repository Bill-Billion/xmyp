...
var strength = 0;
var _usr$pwd$login$form = {
  usr: document.getElementById("usrname"),
  pwd: document.getElementById("usrpwd"),
  login: document.getElementById("btn"),
  form: document.getElementById("login_form")
},
    usr = _usr$pwd$login$form.usr,
    pwd = _usr$pwd$login$form.pwd,
    login = _usr$pwd$login$form.login,
    form = _usr$pwd$login$form.form;
